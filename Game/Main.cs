                            ...
                            switch (splittedMsg[0].ToLower())
                            {
                                ...
                                case "!explore":
                                    if (player.playerState == PlayerState.Free)
                                    {
                                        ...
                                        ChatSender.SendChatMessage("Where would you like to explore? Respond with !option #. " + Options.PresentAsOptions(destinations, Destinations.DestinationToName, out player.lastOptionsString), player.username);
